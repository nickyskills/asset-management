                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.expenses.update", [$expense->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('due_date') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="due_date" id="due_date" value="{{ old('due_date', $expense->due_date) }}">
                        ...
                        <div class="form-group {{ $errors->has('updated_by') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="updated_by_id" id="updated_by_id">
                                @foreach($updated_bies as $id => $updated_by)
                                    <option value="{{ $id }}" {{ ($expense->updated_by ? $expense->updated_by->id : old('updated_by_id')) == $id ? 'selected' : '' }}>{{ $updated_by }}</option>
                                @endforeach
                            </select>
