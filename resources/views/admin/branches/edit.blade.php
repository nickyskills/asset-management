                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.branches.update", [$branch->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $branch->name) }}">
                            @if($errors->has('name'))
                        ...
                        <div class="form-group {{ $errors->has('address') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="address" id="address" value="{{ old('address', $branch->address) }}">
                        ...
                        <div class="form-group {{ $errors->has('contact_person') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="contact_person" id="contact_person" value="{{ old('contact_person', $branch->contact_person) }}">
                        ...
                        <div class="form-group {{ $errors->has('department') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="department" id="department" value="{{ old('department', $branch->department) }}">
                        ...
                        <div class="form-group {{ $errors->has('zone') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="zone" id="zone" value="{{ old('zone', $branch->zone) }}">
                            @if($errors->has('zone'))
